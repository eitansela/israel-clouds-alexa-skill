...
var stateHandlers = {
    startModeIntentHandlers: Alexa.CreateStateHandler(constants.states.START_MODE, {
        ...
        'LaunchRequest': function() {
            ...
            var message = 'Welcome to the Israel Clouds Podcast. You can say, play the audio to begin the podcast.';
        ...
        'PlayAudio': function() {
            console.log("PlayAudio - START_MODE - Start");
            if (!this.attributes['playOrder']) {
                ...
                //  Change state to START_MODE
                this.handler.state = constants.states.START_MODE;
                console.log("PlayAudio - START_MODE - this.attributes: ", this.attributes);
            }
    ...
    playModeIntentHandlers: Alexa.CreateStateHandler(constants.states.PLAY_MODE, {
        ...
        'LaunchRequest': function() {
             ...
             */
            console.log("LaunchRequest - PLAY_MODE - Start");

            var message;
            var reprompt;
            if (this.attributes['playbackFinished']) {
                this.handler.state = constants.states.START_MODE;
                message = 'Welcome to the Israel Clouds Podcast. You can say, play the audio to begin the podcast.';
                reprompt = 'You can say, play the audio, to begin.';
            } else {
                console.log("LaunchRequest - PLAY_MODE - not playbackFinished");
        ...
        'PlayAudio': function() {
            console.log("PlayAudio - PLAY_MODE - Start");
            controller.play.call(this)
        },
        'SkipAhead': function() {
            console.log("SkipAhead - PLAY_MODE - Start - this.attributes: ", this.attributes);

            this.attributes['offsetInMilliseconds'] += 30000;

            console.log("SkipAhead - PLAY_MODE - End - this.attributes: ", this.attributes);
            controller.play.call(this);
        },
        ...
        'AMAZON.HelpIntent': function() {
            ...
            console.log("AMAZON.HelpIntent - PLAY_MODE - Start");
            var message = 'You are listening to the Israel Clouds Podcast. You can say, Next or Previous to navigate through the playlist. ' +
    ...
    resumeDecisionModeIntentHandlers: Alexa.CreateStateHandler(constants.states.RESUME_DECISION_MODE, {
         ...
         */
        'LaunchRequest': function() {
            console.log("LaunchRequest - RESUME_DECISION_MODE - Start");
        ...
        'AMAZON.HelpIntent': function() {
            console.log("AMAZON.HelpIntent - RESUME_DECISION_MODE - Start");
